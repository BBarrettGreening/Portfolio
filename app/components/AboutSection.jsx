        ...
        <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-8 xl:gap-16 sm:py-16 xl:px-16 ">
          ...
          <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
            ...
            <p className="test-base md:text-lg">
              I&apos;m Bustamante Barrett-Greening, a 20 year old student currently studying BSc (Hons) Computer Science at the University of Plymouth, I&apos;m currently working in the WebOps team at HM Land Registry as a placement student for Stage 3 of my course. This page is a showcase of my personal projects and achievements, designed to expand as I progress through my studies and career. I&apos;m always looking for new projects and challenges so contact me to find out how I can help you.
            </p>
